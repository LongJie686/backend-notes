...
在线访问：[longjie686.github.io/backend-notes](https://longjie686.github.io/backend-notes/)
...
| 主题 | 内容 |
|------|------|
| MySQL 学习笔记（7 讲） | 表设计、索引、事务、隔离级别、MVCC、锁机制、慢查询优化 |
...
| 主题 | 内容 |
|------|------|
| 大模型应用开发（8 讲） | LLM 基础、Prompt 工程、RAG 系统、Agent、微调、部署、安全 |
| 多智能体设计实战（9 讲） | 架构模式、角色编排、知识管理、工具调用、可观测性、生产部署 |
...
- 使用 [Obsidian](https://obsidian.md/) 日常编写
- GitHub Actions 自动部署
